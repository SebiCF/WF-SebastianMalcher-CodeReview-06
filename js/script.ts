class solarObject {
    ...
    displayDetails() {
        return `<div class="card mb-4 box-shadow">
            ...
            <p class="col-12 col-md-6 card-text lead text-light px-4" style="line-height: 1.5">${this.solarObjectLongInfo}</p>
            <div class="col-12 col-md-6 card-text lead text-light">
                <div class="col-12 row mb-2 p-0">
                <p class="col-12 text-center text-md-left col-md-6 col-lg-5 my-0 mx-auto ml-auto">Equatorial radius:</p><p class="mx-auto text-center text-md-left col-12 col-md-8 col-lg-6 my-0 ml-auto">${this.solarObjectRadius}</p>
                </div>
                <br>
                <div class="col-12 row mb-2 p-0">
                <p class="col-12 text-center text-md-left col-md-6 col-lg-5 my-0 mx-auto ml-md-auto">Mass:</p><p class="col-12 col-md mx-auto text-center text-md-left col-lg-6 my-0 ml-md-auto">${this.solarObjectMass}</p>
                </div>
                <br>
                <div class="col-12 row mb-2 p-0">
                <p class="col-12 text-center text-md-left col-md-6 col-lg-5 mx-auto my-0 ml-auto">Temperature:</p><p class="col-12 mx-auto text-center text-md-left ol-md-8 col-lg-6 my-0 ml-auto">${this.solarObjectTemperature}</p>
                </div>
                <br>
                <div class="col-12 row mb-2 p-0">
                <p class="col-12 text-center text-md-left col-md-6 col-lg-5 mx-auto my-0 ml-auto">Oribital period:</p> <p class="mx-auto text-center text-md-left col-12 col-md-8 col-lg-6 my-0 ml-auto">${this.solarObjectOrbital}</p>
                </div>
                <br>
                <div class="col-12 row mb-2 p-0">
                <p class="col-12 text-center text-md-left col-md-6 col-lg-5 mx-auto my-0 ml-auto">Rotation period:</p> <p class="mx-auto text-center text-md-left col-12 col-md-8 col-lg-6 my-0 ml-auto">${this.solarObjectRotation}</p>
                </div>
                <br>
            </div>
...
class Bar extends solarObject {
    constructor(
        ...
        public barInfo: string,
        public barMenu: string,
        public barImg: string) {
        super(solarObjectName,
            solarObjectShortInfo,
            solarObjectImg,
            solarObjectLongInfo,
...
let venus = solarObjects.push(new solarObject("Venus", "Although its beautiful name suggests otherwise, Venus is like Hell on Earth.", "./img/venus.png", "Second planet from the Sun and our closest planetary neighbor, Venus is similar in structure and size to Earth, but it is now a very different world. Venus spins slowly in the opposite direction most planets do. Its thick atmosphere traps heat in a runaway greenhouse effect, making it the hottest planet in our solar system—with surface temperatures hot enough to melt lead. Glimpses below the clouds reveal volcanoes and deformed mountains.", "6,051.8km or 0.95 Earths", "4.8675×1024kg or 0.815 Earths", "~460°C on surface", "225 days", "243 days"));
...
function displayContent() {
    ...
    allLearnMoreBtns.forEach(function (elem) {
        elem.addEventListener("click", function (e) {
            let clickedPlanet: number = e.target!.dataset.objectnumber;
...
function displayDetailsContent(clickedPlanet: number) {
    ...
    let currentSolarObjectName: string = solarObjects[clickedPlanet].solarObjectName;
...
function displayPlaces(currentSolarObjectName: string) {
...
function displayEvents(currentSolarObjectName: string) {
...
function displayBars(currentSolarObjectName: string) {

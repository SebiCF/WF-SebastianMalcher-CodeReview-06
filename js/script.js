...
class EventClass extends solarObject {
    constructor(solarObjectName, solarObjectShortInfo, solarObjectImg, solarObjectLongInfo, solarObjectRadius, solarObjectMass, solarObjectTemperature, solarObjectOrbital, solarObjectRotation, eventName, eventAddress, eventInfo, eventImg) {
        super(solarObjectName, solarObjectShortInfo, solarObjectImg, solarObjectLongInfo, solarObjectRadius, solarObjectMass, solarObjectTemperature, solarObjectOrbital, solarObjectRotation);
        this.solarObjectName = solarObjectName;
        this.solarObjectShortInfo = solarObjectShortInfo;
        this.solarObjectImg = solarObjectImg;
...
class Restaurants extends solarObject {
    constructor(solarObjectName, solarObjectShortInfo, solarObjectImg, solarObjectLongInfo, solarObjectRadius, solarObjectMass, solarObjectTemperature, solarObjectOrbital, solarObjectRotation, restaurantName, restaurantAddress, restaurantInfo, restaurantImg) {
        super(solarObjectName, solarObjectShortInfo, solarObjectImg, solarObjectLongInfo, solarObjectRadius, solarObjectMass, solarObjectTemperature, solarObjectOrbital, solarObjectRotation);
        this.solarObjectName = solarObjectName;
        this.solarObjectShortInfo = solarObjectShortInfo;
        this.solarObjectImg = solarObjectImg;
